...
print(args.core.replace('<1>', '[$(C);!$(C(~C)~C)]').replace('<2>', '[$(C);!$(C(~C)(~C)~C)]').replace('<3>', '[$(C);!$(C(~C)(~C)(~C)~C)]').replace('<1a>', '[$(C);!$(C(~C)~C)]').replace('<2r>', '[$([CR0]);!$(C(~C)(~C)~C)]').replace('<3r>', '[$([CR0]);!$(C(~C)(~C)(~C)~C)]').replace('<4r>', '[CR0]').replace('<c>', '[$(c);!$(c(c)(c)C)]').replace('<1q>', '[$([#6]);!$([#6](~[#6])~C)]').replace('<2q>', '[$([#6]);!$([#6](~[#6])(~[#6])~C)]').replace('<3q>', '[$([#6]);!$([#6](~[#6])(~[#6])(~[#6])~C)]'))
